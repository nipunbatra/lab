...
.cropped-image {
  ...
  border-bottom: 4px solid #d9534f; /* Set a thicker border only at the bottom (slightly darker than tomato) */
...
.cropped-image:hover {
  ...
  border-color: #d9534f; /* Use the same slightly darker color on hover */
}
